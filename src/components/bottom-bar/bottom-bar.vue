<template>
  <nav
    class="absolute bottom-0 flex flex-col justify-center items-center w-1/1 md:w-auto mt-auto md:mb-5 p-1 shadow-lg md:rounded-lg bg-gradient-to-br from-gray-900/75 to-gray-900/20 transition-all duration-500"
    :class="{ open }"
  >
    <VolumeSlider />
